...
type
  ...
  protected
    ...
    function GetFTextMargins: TBounds;
    procedure SetFTextMargins(const Value: TBounds);
  ...
  published
    ...
    property TextMargins: TBounds read GetFTextMargins write SetFTextMargins;
...
begin
  ...
  begin
    ...
    Aux := Max(FBackgroundSelect.Width, FBackgroundSelect.Height) * 0.95;
...
function TTransparentRectangleButton.GetFTextMargins: TBounds;
begin
  Result := FText.Margins;
end;
...
procedure TTransparentRectangleButton.SetFTextMargins(const Value: TBounds);
begin
  FText.Margins := Value;
end;
