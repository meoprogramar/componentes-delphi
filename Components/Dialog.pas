...
type
  ...
  protected
    ...
    function GetFCornerRoundBackgroud: Single;
    procedure SetFCornerRoundBackgroud(const Value: Single);
  ...
  published
    ...
    property CornerRoundBackgroud: Single read GetFCornerRoundBackgroud write SetFCornerRoundBackgroud;
...
function TDialog.GetFCornerRoundBackgroud: Single;
begin
  Result := FDefocusBackgroundCard.XRadius;
end;
...
procedure TDialog.SetFCornerRoundBackgroud(const Value: Single);
begin
  FDefocusBackgroundCard.XRadius := Value;
  FDefocusBackgroundCard.YRadius := Value;
end;
